...
function LeftNav() {
  ...
  return (
    <div className={`md:block w-[240px] overflow-y-auto h-full py-4 bg-black absolute md:relative z-10 translate-x-[-240px] md:translate-x-0 transition-all no-scrollbar hover:show-scrollbar ${mobileMenu ? "left-nav-translate" : ""}`}>
